...
<link rel="stylesheet" type="text/css" href="src/libs/jquery-ui-1.12.1.custom/jquery-ui.css">
...
<h4 class="subtitulo text-center">CATALOGO DE PRODUCTOS</h4>
<hr>
<div class="container-fluid">
	<div class="row">
		<div class="col-3 text-center">
<button type="button" id="agricola" class="btn btn-success">Agricolas</button>	
</div>
<div class="col-3 text-center">
<button type="button" id="ganadero" class="btn btn-success">Ganaderos</button>	
</div>
<div class="col-3 text-center">
<button type="button" id="otros" class="btn btn-success">Otros</button>	
</div>
<div class="col-3 text-center">
<button type="button" id="todos" class="btn btn-success">Todos los productos</button>	

</div>
</div>
</div>
<hr>
<h4 class="subtitulo text-center"><?php echo strtoupper($nombre);?></h4>
<div class='espacio container-fluid text-center '>
<div class='row'>
<?php foreach ($result as $product) {?>
 <div class='espacio col-4 bg-faded '>
	<div class='contProduct  '>
	<a href="<?php echo $product['foto_producto'] ?>" data-lightbox="galeria" ><img class='imageProduct img-responsive' src='<?php echo $product['foto_producto'] ?>' rel="<?php echo $product['foto_producto']?>"></a>
	<?php echo $product["nombre"]; ?>
	<br></br>
   <button id='<?php echo $product['id_producto'] ?>' class="ver btn btn-success" type="submit">Detalles</button>
	</div>
	</div>
<?php } ?>
	</div>
...
<?php for ($i=1; $i <= $paginar ; $i++) { ?>

    <li class='page-item'><a class='pagin page-link' id="<?php echo $i.','.$opcion ?>" role="button"><?php echo $i ?></a></li>
