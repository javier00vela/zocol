...
<h1 class="titulo text-center">PEDIDOS Y/O VENTAS CANCELADAS</h1>
<?php if(!isset($_SESSION)){ session_start(); } 
  if (count($_SESSION["secCancelados"]) != 0) { ?>
  <table>
  	<thead>
	<div class="container-fluid">
		...
		<?php foreach ($_SESSION["secCancelados"] as $product) { ?> 
  ...
  <table>
	...
	<div class="container-fluid">
		<div class="row text-center">
				...
				<div class="col-3">
					<label><button class=" btnDetalles btn btn-success" data-id="<?php echo $product["id_pedido"]."-"."1"."-".$product["fk_producto"] ?>">detalles</button>
				</div>	
...
<div class="contenedor container-fluid  ">
	<div class="cuadro row">
		<div class="vacio col-12 text-center bg-faded">
			<h1 class="textoCanasta">NO HAY PEDIDOS O VENTAS CANCELADOS </h1>
